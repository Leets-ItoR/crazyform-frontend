    ...
    >
      <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
        ...
        <div class="items-center grid gap-2">
          <div class="items-center sm:flex gap-4">
            <button
              class="flex items-center bg-white-50 border border-gray-300 rounded-lg hover:bg-gray-100 font-medium p-2"
            >
              <img class="w-4 h-4 mr-2" src={googleLogo} alt="googleLogo" />
              Log in with Google
            </button>
            <button
              class="flex items-center bg-white-50 border border-gray-300 rounded-lg hover:bg-gray-100 font-medium p-2"
            >
              <img class="w-5 h-5 mr-2" src={naverLogo} alt="naverLogo" />
              Log in with Naver
            </button>
          </div>
          <div class="items-center sm:flex gap-4">
            ...
            <button
              class="flex items-center bg-white-50 border border-gray-300 rounded-lg hover:bg-gray-100 font-medium p-2"
            >
              <img class="w-5 h-5 mr-2" src={appleLogo} alt="appleLogo" />
