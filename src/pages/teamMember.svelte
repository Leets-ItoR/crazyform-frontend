...
<section class="bg-white dark:bg-gray-900">
    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        ...
        <div class="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
            ...
            >
                We are the powerful team. <br />Introduction our team members.
            </p>
        </div>
            ...
            >
                ...
                <div class="p-6">
                    ...
                    <p
                        class="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400"
                    >
                        Juha love travel. Don't mind suggesting he go on a trip
                        with you.
                    </p>
            ...
            >
                ...
                <div class="p-6">
                    ...
                    <p
                        class="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400"
                    >
                        here is the page just for Donghyeon
                    </p>
                    <ul class="flex space-x-4 sm:mt-0">
                        <li>
                            <a
            ...
            >
                ...
                <div class="p-6">
                    ...
                    <p
                        class="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400"
                    >
                        Daegyeom is a genius in algorithms
                    </p>
                    <ul class="flex space-x-4 sm:mt-0">
                        <li>
                            <a
